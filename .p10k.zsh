# Generated by Powerlevel10k configuration wizard on 2024-01-04 at 13:16 EST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    month_icon              # my user-defined segment
  )
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=020
  ...
  typeset -g POWERLEVEL9K_TERRAFORM_VERSION_SHOW_ON_COMMAND='terraform|tf|terragrunt'

  #############[ kubecontext: current kubernetes context (https://kubernetes.io/) ]#############
  # Show kubecontext only when the command you are typing invokes one of these tools.
  # Tip: Remove the next line to always show kubecontext.
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern|kubeseal|skaffold|kubent|kubecolor|cmctl|sparkctl|kubie'
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      '*prod*'     PROD    # These values are examples that are unlikely
      '*stg*'  STAGING    # to match your needs. Customize them as needed.
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_STAGING_FOREGROUND=7
  typeset -g POWERLEVEL9K_KUBECONTEXT_STAGING_BACKGROUND=172
  typeset -g POWERLEVEL9K_KUBECONTEXT_QA_FOREGROUND=0
  typeset -g POWERLEVEL9K_KUBECONTEXT_QA_BACKGROUND=190
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_STAGING_CONTENT_EXPANSION=
  # Show P9K_KUBECONTEXT_CLOUD_CLUSTER if it's not empty and fall back to P9K_KUBECONTEXT_NAME.
  POWERLEVEL9K_KUBECONTEXT_STAGING_CONTENT_EXPANSION+='${P9K_KUBECONTEXT_CLOUD_CLUSTER:-${P9K_KUBECONTEXT_NAME}}'
  # Append the current context's namespace if it's not "default".
  POWERLEVEL9K_KUBECONTEXT_STAGING_CONTENT_EXPANSION+='${${:-/$P9K_KUBECONTEXT_NAMESPACE}:#/default}'

  typeset -g POWERLEVEL9K_KUBECONTEXT_QA_CONTENT_EXPANSION=
  # Show P9K_KUBECONTEXT_CLOUD_CLUSTER if it's not empty and fall back to P9K_KUBECONTEXT_NAME.
  POWERLEVEL9K_KUBECONTEXT_QA_CONTENT_EXPANSION+='${P9K_KUBECONTEXT_CLOUD_CLUSTER:-${P9K_KUBECONTEXT_NAME}}'
  # Append the current context's namespace if it's not "default".
  POWERLEVEL9K_KUBECONTEXT_QA_CONTENT_EXPANSION+='${${:-/$P9K_KUBECONTEXT_NAMESPACE}:#/default}'
  ...
  typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='aws|awless|terraform|pulumi|terragrunt|asp'
